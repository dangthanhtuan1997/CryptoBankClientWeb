                                        ...
                                        <div className="nk-block-between-md g-4">
                                            ...
                                            <div className="nk-block-head-content">
                                                <ul className="nk-block-tools gx-3">
                                                    <li className="btn-wrap"><a href="#" className="btn btn-icon btn-xl btn-dim btn-outline-light"><em className="icon ni ni-arrow-from-right" /></a><span className="btn-extext">Send</span></li>
                                                    <li className="btn-wrap"><a href="#" className="btn btn-icon btn-xl btn-success"><em className="icon ni ni-wallet-in" /></a><span className="btn-extext">Deposit</span></li>
                                                    <li className="btn-wrap"><a href="#" className="btn btn-icon btn-xl btn-warning"><em className="icon ni ni-wallet-out" /></a><span className="btn-extext">Withdraw</span></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>{/* .nk-block-head */}
