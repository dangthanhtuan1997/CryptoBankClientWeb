                            ...
                            <div className="nk-sidebar-widget d-none d-xl-block">
                                <div className="user-account-info between-center">
                                    <div className="user-account-main">
                                        ...
                                        <div className="user-balance">150.255.000 <small className="currency">VND</small></div>
                                    </div>
                                ...
                                <ul className="user-account-data gy-1">
                                    <li>
                                        ...
                                        <div className="user-account-value">
                                            <span className="lead-text">50.255.000 <span className="currency">VND</span></span>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="user-account-label">
                                        ...
                                        <div className="user-account-value">
                                            <span className="sub-text">100.000.000 <span className="currency">VND</span></span>
                                        </div>
                                    </li>
                                </ul>
